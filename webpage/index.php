...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["cpassword"])) {
        ...
        if (!$valid_password($cpasswordErr) or $cpassword != $password) {
    ...
    if (empty($_POST["postal code"])) {
        ...
        if (!$valid_postal_code($postalcode)) {
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <br><br>
    Marital Status:
    <input type="radio" name="status" <?php if (isset($status) && $status == "female") echo "checked"; ?>
           value="female">Single
    ...
    Credit Card Expiry Date:<input type="date" name="card expiry" value="<?php echo $creditE; ?>">
